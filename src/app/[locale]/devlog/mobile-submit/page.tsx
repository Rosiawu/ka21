...
type DevLogMobileSubmitPageParams = Promise<{ locale: string }>;

export default async function DevLogMobileSubmitPage({ params }: { params: DevLogMobileSubmitPageParams }) {
