...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    name: "倒放",
    title: "AI病友",
    avatar: "/images/team/avatar-daofang.png",
    location: "杭州",
    specialty: "短视频,音乐",
    wechatQR: "/images/team/qr-daofang.jpg",
    wechatAccount: "倒放",
    aiTools: ["抖音音乐开放平台", "豆包", "Gemini", "Codex"],
    description: "需要脑暴创意突围时可能帮得到，但求别逼太急，不然脑子短路。",
    skills: ["短视频创作", "音乐创作"],
    personalTraits: ["感谢 ka21 佬们提携", "创意脑暴", "灵感突围"]
  },
  {
    id: "jiyutao",
    name: "计育韬",
    title: "图书作者 / 交互动画设计师",
    avatar: "/images/team/avatar-jiyutao.png",
    location: "上海",
    specialty: "交互设计,动画设计",
    wechatQR: "/images/team/qr-jiyutao.jpg",
    wechatAccount: "JZCreative",
    aiTools: ["Cursor", "即梦", "Gemini"],
    description: "SVG AttributeName 白名单制定人，起草《中小商业企业协会融媒体 SVG 交互设计技术规范》。",
    skills: ["交互设计", "动画设计", "SVG 规范制定"],
    projectHighlights: ["《硬核运营：技术流新媒体养成》作者", "《Prezi完全解读》作者"],
    personalTraits: ["长期主义", "技术表达", "规范建设"]
  },
  {
    id: "baisuelliot",
    name: "白苏Elliot",
    title: "Mew.Design 联创",
    avatar: "/images/team/avatar-baisuelliot.jpg",
    location: "上海",
    specialty: "AI agent,出海,产品",
    mbti: "INTJ",
    wechatQR: "/images/team/qr-baisuelliot.jpg",
    wechatAccount: "白苏Elliot",
    aiTools: ["Codex", "Claude Code", "OpenCode"],
    description: "干活博主，曾单人手搓百万用户 AI agent。",
    skills: ["AI Agent", "出海产品", "产品设计"],
    personalTraits: ["现在是最好的时代", "实干派", "长期搭建"]
  },
  {
    id: "hexiansenkevin",
    name: "何先森Kevin",
    title: "AIGC创作者",
    avatar: "/images/team/avatar-hexiansenkevin.png",
    location: "北京",
    specialty: "写作,设计,摄影,品牌策划,自媒体运营",
    wechatQR: "/images/team/qr-hexiansenkevin.png",
    wechatAccount: "AIGC创意猎人",
    aiTools: ["OpenClaw", "Gemini", "NotebookLM", "Lovart", "TapNow"],
    description: "专注于 AIGC 艺术、AI 创新应用、AI 商业观察与个人成长分享。",
    skills: ["写作", "品牌策划", "自媒体运营"],
    personalTraits: ["创意观察", "商业敏感度", "持续分享"]
  },
  {
    id: "luoxiaoshan",
    name: "洛小山",
    title: "AI 产品经理",
    avatar: "/images/team/avatar-luoxiaoshan.jpg",
    location: "珠海",
    specialty: "AI 工程化,AI 模型评估",
    wechatQR: "/images/team/qr-luoxiaoshan.jpg",
    wechatAccount: "洛小山",
    aiTools: ["Cursor", "XSCT"],
    description: "你学习 AI 的搭子。",
    skills: ["AI工程化", "AI模型评估"],
    personalTraits: ["陪伴学习", "产品视角", "方法论导向"]
  },
  {
    id: "suanmeizhujiu",
    name: "酸梅煮酒",
    title: "纪录片导演 / 剪辑师",
    avatar: "/images/team/avatar-suanmeizhujiu.png",
    location: "重庆",
    specialty: "AI视频,纪录片,摄影,vibecoding",
    wechatQR: "/images/team/qr-suanmeizhujiu.jpg",
    wechatAccount: "酸梅煮酒",
    aiTools: ["Codex", "ChatGPT", "可灵", "即梦", "Lovart", "Gemini"],
    description: "纪录片独立制作者，AI实干家，一个人一支队伍。",
    skills: ["纪录片制作", "剪辑", "AI视频创作"],
    personalTraits: ["一个人就是一支队伍", "独立制作", "实干派"]
  },
  {
    id: "tatalab",
    name: "TATALAB",
    title: "AI 自媒体博主 / 独立开发者",
    avatar: "/images/team/avatar-tatalab.png",
    location: "上海 / 杭州",
    specialty: "AI设计与生图,创意视频TVC,vibecoding创意项目开发",
    mbti: "ENTJ",
    wechatQR: "/images/team/qr-tatalab.jpg",
    wechatAccount: "TATALAB",
    aiTools: ["Obsidian", "Claude", "即梦", "Lovart", "秒哒"],
    description: "从宝妈到小红书 AI 科技博主，拥有 1.4w+ 粉丝，只用了一年，践行 learn in public，一起学习吧～",
    skills: ["AI设计与生图", "创意视频TVC", "独立开发"],
    personalTraits: ["你的 AI 时代课代表", "公开学习", "执行力强"]
  },
  {
    id: "huangama",
    name: "黄啊码",
    title: "创业公司 CTO",
    avatar: "/images/team/avatar-huangama.jpg",
    location: "广州",
    specialty: "AI Coding,智能体工作流定制",
    wechatQR: "/images/team/qr-huangama.jpg",
    wechatAccount: "黄啊码",
    aiTools: ["Claude Code", "Codex", "Cursor", "即梦"],
    description: "人工训练师、人工智能讲师，擅长企业业务梳理和 AI 转型。",
    skills: ["AI Coding", "智能体工作流", "企业 AI 转型"],
    personalTraits: ["跟 AI 相处久了更像 AI 分身", "企业落地", "系统梳理"]
  },
  {
    id: "yuntian",
    name: "云天AI探索",
    title: "AI产品经理 / 极限运动达人",
    avatar: "/images/team/avatar-yuntian.jpg",
    location: "北京",
    specialty: "AI编程,AIPPT,AI出海,创意探索",
    mbti: "ENFP",
    wechatQR: "/images/team/qr-yuntian.jpg",
    wechatAccount: "云天AI探索",
    aiTools: ["Gemini", "CodeBuddy", "Claude Code", "YouMind", "ListenHub"],
    description: "探索 AI 生产力革新，放大被低估的价值。",
    skills: ["AI编程", "AIPPT", "AI出海"],
    personalTraits: ["极限运动", "价值放大器", "创意探索"]
  },
  {
    id: "tuhuijiscott",
    name: "兔会计Scott",
    title: "锐意知能创始人 / 财AI客厅社群主理人",
    avatar: "/images/team/avatar-tuhuijiscott.jpg",
    location: "北京",
    specialty: "项目管理AI,财务 AI 落地,德国见闻,培训与演讲",
    wechatQR: "/images/team/qr-tuhuijiscott.jpg",
    wechatAccount: "兔会",
    aiTools: ["Claude", "Codex", "项齐 AI 项目管理", "NotebookLM"],
    description: "专注 Vibe 项目管理，旅德 7 年，拥有 8 年四大与财务经验。",
    skills: ["项目管理AI", "财务 AI 落地", "培训与演讲"],
    personalTraits: ["跨界财务视角", "项目管理实践", "全球化经历"]
  },
  {
    id: "bierchangbaicao",
    name: "比尔尝百草",
    title: "AI行业分析师",
    avatar: "/images/team/avatar-bierchangbaicao.jpg",
    location: "北京",
    specialty: "AI一手新行业动态洞察",
    mbti: "ESFP",
    wechatQR: "/images/team/qr-bierchangbaicao.jpeg",
    wechatAccount: "比尔AI新视界",
    description: "管理咨询背景 AI 行业分析师，持续拆解 AI 行业的真实发展情况。",
    skills: ["AI行业洞察", "趋势分析", "咨询研究"],
    personalTraits: ["行业观察", "真实拆解", "咨询视角"]
  }
];
